...
legend('show')
% csvwrite('A2-blocking-both-classes.csv', [beta3, x3(:, 2)/2200, x3(:, 4)/240])
...
% hold on;
semilogx(beta3, x3(:, 3)/1e3, 'displayname', 'mouse~(50, 25)')
hold on;
semilogx(beta3, x3(:, 5)/1e3, 'displayname', 'elephant~(400, 25)')
% hold on;
