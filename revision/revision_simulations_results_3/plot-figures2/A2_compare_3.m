...
x1 = csvread('A2_mice_30_25_elep_380_25_L1_0.05_L2_0.35.csv');
x2 = csvread('A2_mice_50_0_elep_400_0_L1_0.05_L2_0.35.csv');
x3 = csvread('A2_mice_50_25_elep_400_25_L1_0.05_L2_0.35.csv');
x4 = csvread('A2_mice_50_50_elep_400_50_L1_0.05_L2_0.35.csv');
x5 = csvread('A2_mice_70_25_elep_420_25_L1_0.05_L2_0.35.csv');
beta1 = x1(:, 1);
beta1(1) = 1e-8;
beta2 = x2(:, 1);
beta2(1) = 1e-8;
...
% hold on;
semilogx(beta3, x3(:, 2)/2200, 'displayname', 'mouse~(50, 25)')
hold on;
semilogx(beta3, x3(:, 4)/240, 'displayname', 'elephant~(400, 25)')
% hold on;
...
figure;
% semilogx(beta1, x1(:, 3)/1e3, 'displayname', 'mouse~(25, 10)')
% hold on;
% semilogx(beta1, x1(:, 5)/1e3, 'displayname', 'elephant~(350, 10)')
% hold on;
% semilogx(beta2, x2(:, 3)/1e3, 'displayname', 'mouse~(50, 0)')
% hold on;
% semilogx(beta2, x2(:, 5)/1e3, 'displayname', 'elephant~(400, 0)')
% hold on;
semilogx(beta3, x3(:, 3)/1e3-5, 'displayname', 'mouse~(50, 25)')
hold on;
semilogx(beta3, x3(:, 5)/1e3+5, 'displayname', 'elephant~(400, 25)')
% hold on;
...
legend('show')
csvwrite('A2-throughput-both-classes.csv', [beta3, x3(:, 3)/1e3-5, x3(:, 5)/1e3+5])