...
plot(x3Connection, x3Throughput, 'marker', '^', 'displayname', '\mu (75, 425), \sigma (50, 50)')
plot(x4Connection, x4Throughput, 'marker', '^', 'displayname', '\mu (100, 450), \sigma (75, 75)')
legend('show')
title('Pareto curves')
...
% hold on;
semilogx(beta2, 1-x2(:, 2)/numberMice2, 'displayname', 'mouse~25')
hold on;
...
hold on;
semilogx(beta3, 1-x3(:, 4)/numberElephant3, 'displayname', 'mouse~50')
hold on;
