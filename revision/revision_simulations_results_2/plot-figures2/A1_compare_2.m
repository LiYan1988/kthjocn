...
x3 = csvread('A1_mice_50_10_elep_400_20_L1_0.1_L2_0.95-good.csv');
x4 = csvread('A1_mice_50_25_elep_400_50_L1_0.1_L2_0.95-good.csv');
...
plot(x6Connection, x6Throughput, 'marker', '^', 'displayname', '\mu (50, 400), \sigma (50, 50)')
legend('show')
